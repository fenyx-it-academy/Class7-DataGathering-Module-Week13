...
def is_iss_overhead():
    ...
    iss_latitude = json_response.get("iss_position").get('latitude')
    iss_longitude = json_response.get("iss_position").get('longitude')
...
def is_night_time():
    ...
    sunrise = json_response.get('results').get('sunrise')
    sunset = json_response.get('results').get('sunset')
